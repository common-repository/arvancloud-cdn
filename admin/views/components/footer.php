...
<div class="acs-footer">
    <div class="acs-footer-links">        
        <ul>
            <li><a href="https://panel.arvancloud.ir/cdn/<?php echo Helper::get_site_domain(); ?>/plans" target="_blank" rel="noopener noreferrer"><?php echo esc_html_e( 'CDN Plans', 'arvancloud-cdn' ) ?> <span class="dashicons dashicons-external"></span></a></li>
            <li><a href="https://forum.arvancloud.ir/c/cdn/47" target="_blank" rel="noopener noreferrer"><?php echo esc_html_e( 'Support', 'arvancloud-cdn' ) ?> <span class="dashicons dashicons-external"></span></a></li>
            <li><a href="mailto:support@arvancloud.ir" target="_blank" rel="noopener noreferrer"><?php echo esc_html_e( 'Email Us', 'arvancloud-cdn' ) ?> <span class="dashicons dashicons-email"></span></a></li>
        </ul>
    </div>
    <div class="acs-footer-social">
        <div class="footer__social-icons">
            <?php 
            if ( get_locale() == 'fa_IR' ) {
                echo wp_kses_post('<a class="footer__social-icons__link footer__social-icons--telegram" href="https://t.me/arvancloud" target="_blank" rel="noopener noreferrer">
            ...
            <a class="footer__social-icons__link footer__social-icons--linkedin" href="<?php echo esc_url(get_locale() == 'fa_IR' ? 'https://www.linkedin.com/company/arvancloud-fa' : 'https://www.linkedin.com/company/arvancloud') ?>" target="_blank" rel="noopener noreferrer">
            ...
            <a class="footer__social-icons__link footer__social-icons--twitter" href="<?php echo esc_url(get_locale() == 'fa_IR' ? 'https://twitter.com/ArvanCloud_fa' : 'https://twitter.com/ArvanCloud') ?>" target="_blank" rel="noopener noreferrer">
            ...
            <a class="footer__social-icons__link footer__social-icons--instagram" href="<?php echo esc_url(get_locale() == 'fa_IR' ? 'https://instagram.com/arvancloud_fa' : 'https://www.instagram.com/arvancloud') ?>" target="_blank" rel="noopener noreferrer">
